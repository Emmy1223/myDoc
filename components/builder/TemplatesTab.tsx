...
function TemplateThumb({ id }: { id: TemplateId }) {
    ...
    return (
      <div className="flex h-full flex-col p-1.5">
        <div className="border-b border-stone-900 pb-1">
          <div className="h-1 w-3/5 bg-stone-900" />
          <div className="mt-0.5 h-0.5 w-2/5 bg-stone-400" />
        </div>
        <div className="mt-1 grid flex-1 grid-cols-[1.6fr_1fr] gap-1.5">
          <div className="space-y-1">
            <div className="h-0.5 w-1/2 bg-stone-900" />
            <div className="h-0.5 w-full bg-stone-300" />
            <div className="h-0.5 w-5/6 bg-stone-300" />
            <div className="mt-1 h-0.5 w-1/2 bg-stone-900" />
            <div className="h-0.5 w-full bg-stone-300" />
            <div className="h-0.5 w-4/5 bg-stone-300" />
            <div className="h-0.5 w-full bg-stone-300" />
          </div>
          <div className="space-y-1 border-l border-stone-300 pl-1">
            <div className="h-0.5 w-3/4 bg-stone-900" />
            <div className="h-0.5 w-full bg-stone-300" />
            <div className="h-0.5 w-5/6 bg-stone-300" />
            <div className="mt-1 h-0.5 w-3/4 bg-stone-900" />
            <div className="h-0.5 w-full bg-stone-300" />
            <div className="h-0.5 w-2/3 bg-stone-300" />
          </div>
        </div>
      </div>
    );
  ...
  if (id === "editorial") {
    return (
      <div className="flex h-full flex-col p-2">
        <div className="h-2 w-4/5 bg-stone-900" />
        <div className="mt-1 h-0.5 w-2/5 bg-stone-500" />
        <div className="mt-1 h-0.5 w-full bg-stone-300" />
        <div className="mt-1.5 flex items-center gap-1">
          <div className="h-0.5 w-1/4 bg-stone-900" />
  ...
  return (
    <div className="flex h-full flex-col p-2">
      <div className="h-1.5 w-3/5 bg-stone-900" />
      <div className="mt-0.5 h-0.5 w-2/5 bg-stone-500" />
      <div className="mt-1 h-[3px] w-1/4 bg-rust" />
      <div className="mt-1.5 flex items-center gap-1">
        <span className="h-[3px] w-1.5 bg-rust" />
      ...
      <div className="mt-1.5 flex flex-wrap gap-1">
        <span className="h-1.5 w-4 border border-rust/40 bg-rust/5" />
        <span className="h-1.5 w-5 border border-rust/40 bg-rust/5" />
        <span className="h-1.5 w-3 border border-rust/40 bg-rust/5" />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="space-y-3 border-t border-stone-200 p-4">
      <p className="text-sm leading-6 text-stone-600">
        Switching layouts keeps every field you have filled in and reflows it
        into the new design.
      </p>
      {templates.map((t) => {
