...
export const templates: {
  ...
  },
  {
    id: "compact",
    name: "Compact",
    description: "Dense two-column layout designed to fit long careers on two pages.",
  },
  {
    id: "editorial",
    name: "Editorial",
    description: "Magazine-inspired layout with serif headings and a two-column summary.",
  },
  {
    id: "modern",
    name: "Modern",
    description: "Clean sans-serif layout with accent rules, timeline dots, and skill chips.",
  },
];
